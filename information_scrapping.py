...
url = "https://www.serebii.net/pokedex-rs/152.shtml"
...
ability = parser.getElementsByTagName('p')[0].getChildren()[1].getChildren()[2].getChildren()[1].getChildren()[0].innerText.strip()
